...
namespace Blade.MG.Core.ColorManagement
{
    ...
    public struct HSBColor
    {
        ...
        public static Color ToRGB(HSBColor hsbColor)
        {
            ...
            {
                case 0:         // red - yellow
                    rgbColor = new Color(hsbColor.B, t, p, hsbColor.A);
                    break;
                case 1:         // yellow - green
                    rgbColor = new Color(q, hsbColor.B, p, hsbColor.A);
                    break;
                case 2:         // green - cyan
                    rgbColor = new Color(p, hsbColor.B, t, hsbColor.A);
                    break;
                case 3:         // cyan - blue
                    rgbColor = new Color(p, q, hsbColor.B, hsbColor.A);
                    break;
                case 4:         // blue - magenta
                    rgbColor = new Color(t, p, hsbColor.B, hsbColor.A);
                    break;
                case 5:
                default:        // magenta - red
                    rgbColor = new Color(hsbColor.B, p, q, hsbColor.A);
                    break;
            }
