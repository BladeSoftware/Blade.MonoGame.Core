...
{
    public class KeyboardUS : KeyboardBase
    {
        ...
        static KeyboardUS()
        {
            ...
            KeyDict.TryAdd(Keys.D2, Tuple.Create("2", "@"));        // Numeric 2
            ...
            KeyDict.TryAdd(Keys.D7, Tuple.Create("7", "&"));        // Numeric 7
            KeyDict.TryAdd(Keys.D8, Tuple.Create("8", "*"));        // Numeric 8
            KeyDict.TryAdd(Keys.D9, Tuple.Create("9", "("));        // Numeric 9
            KeyDict.TryAdd(Keys.D0, Tuple.Create("0", ")"));        // Numeric 0
            ...
            KeyDict.TryAdd(Keys.OemMinus, Tuple.Create("-", "_"));         // For any country/region, the '-' key.
