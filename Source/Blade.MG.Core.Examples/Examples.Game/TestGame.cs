...
namespace Examples
{
    ...
    public class TestGame : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            var img = svg.ToTexture2D(GraphicsDevice, Matrix.CreateScale(1f), new Point(500, 500), 0);
            ...
            using (SpriteBatch spriteBatch = new SpriteBatch(GraphicsDevice))
            {
                try
                {
                    ...
                    spriteBatch.Draw(img, new Rectangle(center.X - svgWidth / 2, center.Y - svgHeight / 2, svgWidth, svgHeight), img.Bounds, Color.White);
